...
SIGNATURE = "code-project-guidance-map skill"
GENERATED_AT_RE = re.compile(r"^Generated at:\s*(?P<value>.+?)\s*$", re.MULTILINE)
GENERATED_BY_RE = re.compile(r"^Generated by:\s*(?P<value>.+?)\s*$", re.MULTILINE)
...
def status(repo_arg: Path) -> dict[str, object]:
    ...
    generated_by = metadata_value(GENERATED_BY_RE, block)
    ...
    return {
        ...
        "requires_full_read": (not has_block) or (has_block and not generated_at_valid),
    }
